...
```
$ ./gnmic_cmd -a <target> <command> [local flags]
```
...
```
$ ./gnmic_cmd.sh -a leaf1 capabilities
gNMI version: 0.10.0
supported models:
...
If gNMIc is installed in the host machine, you may proceed with the following commands (This method is used for most of this document).
